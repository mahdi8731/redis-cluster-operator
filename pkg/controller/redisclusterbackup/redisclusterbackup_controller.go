...
func (r *ReconcileRedisClusterBackup) Reconcile(eq_ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	err := r.client.Get(eq_ctx, request.NamespacedName, instance)
	if err != nil {
